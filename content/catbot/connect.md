...
### laser
the laser has 3 pins, but the middle one does not do anything (it's cheaper to manufacture this way), so the outer two pins from the laser itself connect to the red and blue wires, they later connect to other colors, we will call the blue one (-) and the red one (+).
